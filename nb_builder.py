...
nb = {
    ...
    "cells": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## \ud83d\udd0d 1. Eval Baseline (SPair & PF-Pascal)"]},
        {"cell_type": "code", "metadata": {}, "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## \ud83d\ude80 2. Training (LoRA & BitFit)"]},
        {"cell_type": "code", "metadata": {}, "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## \ud83c\udfaf 3. Raffinamento (Ablation Adaptive Window)"]},
        {"cell_type": "code", "metadata": {}, "source": [
            "print('--- LoRA + AW ---')\n",
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## \ud83c\udf0d 4. Test Finali: PF-Pascal & Temperature Ablation"]},
        {"cell_type": "code", "metadata": {}, "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## \ud83c\udfa8 5. Visual Demos"]},
...
print("Project_Final_v2.ipynb generato in linea con la struttura finale richiesta.")
