...
nb = {
    ...
    "cells": [
        ...
        {"cell_type": "code", "metadata": {}, "source": ["# 2.1 LoRA Only\n!python train.py --peft_type lora --dataset_root ./data/SPair-71k --epochs 5 --curriculum_epochs 0 --exp_name lora_only --output_dir ./checkpoints/lora_only --backup_dir /content/drive/MyDrive/AML/Checkpoints/lora_only"]},
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## 🎯 3. Stage 3: Raffinamento e Confronto Finale\n", "Valutiamo l'impatto dell'Adaptive Window su entrambe le tecniche PEFT."]},
        
        {"cell_type": "markdown", "metadata": {}, "source": ["### 🎯 3.1 Raffinamento LoRA"]},
        {"cell_type": "code", "metadata": {}, "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["### 🎯 3.2 Raffinamento BitFit"]},
        {"cell_type": "code", "metadata": {}, "source": [
            ...
            "launch_stage_demo('BitFit + Adaptive Window', ckpt_name='bitfit_only')"
        ]},
        
        {"cell_type": "markdown", "metadata": {}, "source": ["## 🌟 4. Stage 4: Demo Finale e Analisi\n", "Concludiamo con una valutazione approfondita e la demo interattiva."]},
        {"cell_type": "code", "metadata": {}, "source": ["launch_stage_demo('Modello Finale (LoRA)', ckpt_name='lora_only')"]}
    ]
}

with open("Project_Final_Pipeline.ipynb", "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=2)
print("Notebook aggiornato con confronto LoRA vs BitFit + Adaptive Window!")
